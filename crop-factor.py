...
debug = 0
test_factor = 4 # set to manually control the ratio of the case from which focal length is determined to the known test case
...
if __name__ == "__main__":
    ...
    if not debug:
        ...
        try:
            ...
            try:
                ppix_pct = (dimensions[0] * test_factor) / dimensions[1]
                print "pix pct", pix_pct
